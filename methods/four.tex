\subsection{Regression model quality} It is clear that the reliability of the
\todo{having written, I think it is actually the section \ref{rad} material}
...
study.
\todo{stopped here on Sunday, the text above is slightly less of a shit than it
used to be}
